...
Bu klasör, kişisel site projesinin ürün ve teknik sözleşmelerini içerir.
...
**Cursor kuralları:** [.cursor/rules/generate-rules.mdc](../.cursor/rules/generate-rules.mdc), [.cursor/rules/workflow.mdc](../.cursor/rules/workflow.mdc).
