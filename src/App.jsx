...
function AppsSite() {
  ...
  return (
    <section className="apps-site" aria-label="Embedded apps showcase">
      <StoreSidebar
    ...
    <main>
      ...
      <div className="page">
        ...
        <section className="get-in-touch">
          <h2>Get in touch</h2>
          <p>
            I’m interested in well-scoped products, practical AI-assisted
            engineering workflows, developer tools, and software that feels
            simple from the outside while staying solid underneath.
          </p>
          <p className="inline-link">
            <ArrowUpRight size={16} />{" "}
            <ExternalLink href="mailto:info@burakboduroglu.com.tr">
              Email me directly
            </ExternalLink>
          </p>
