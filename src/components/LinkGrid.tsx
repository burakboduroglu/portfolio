        ...
        {links.map((link) => (
          <article
            ...
            className="bg-gradient-to-br from-space-blue/90 via-[#23234a]/95 to-space-teal/80
                     ...
                     before:bg-gradient-to-br before:from-space-blue/80 before:via-[#23234a]/90 before:to-space-teal/80 hover:cursor-pointer"
          >
            <a
              href={link.url}
              target="_blank"
              ...
              className="flex items-center gap-3 lg:pt-3 md:gap-0 md:flex-1 md:flex-col drop-shadow-md"
              aria-label={`${link.title} adresine git`}
            >
              <FontAwesomeIcon
                icon={link.icon}
                size="xl"
                className="block text-space-silver/70 drop-shadow-md"
                aria-hidden="true"
              />
